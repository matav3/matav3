...
**
** Created: Mon Oct 28 12:58:57 2013
...
public:
    ...
    QAction *actionShow_All_Voxels;
    QAction *actionShowDescendant;
    QAction *actionComputeOcuppance;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionShow_All_Voxels = new QAction(MainWindow);
        actionShow_All_Voxels->setObjectName(QString::fromUtf8("actionShow_All_Voxels"));
        actionShow_All_Voxels->setCheckable(true);
        actionShowDescendant = new QAction(MainWindow);
        actionShowDescendant->setObjectName(QString::fromUtf8("actionShowDescendant"));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8("../../../../../../../home/lucas/data/Code/GoogleDrive/matav3/matav3/img/hand.png"), QSize(), QIcon::Normal, QIcon::On);
        actionShowDescendant->setIcon(icon4);
        actionComputeOcuppance = new QAction(MainWindow);
        actionComputeOcuppance->setObjectName(QString::fromUtf8("actionComputeOcuppance"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/img/ocup.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionComputeOcuppance->setIcon(icon5);
        ...
        menuPlot_Tree_Option->addAction(actionShow_All_Voxels);
        mainToolBar->addAction(actionOpen);
        mainToolBar->addSeparator();
        mainToolBar->addAction(actionZoomPlus);
        mainToolBar->addAction(actionZoomLess);
        mainToolBar->addSeparator();
        mainToolBar->addAction(actionSaveVolume);
        mainToolBar->addAction(actionShowDescendant);
        mainToolBar->addAction(actionComputeOcuppance);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionShow_All_Voxels->setText(QApplication::translate("MainWindow", "Show All Voxels", 0, QApplication::UnicodeUTF8));
        actionShowDescendant->setText(QApplication::translate("MainWindow", "showDescendant", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        actionShowDescendant->setToolTip(QApplication::translate("MainWindow", "<html><head/><body><p>show Descendant</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        actionComputeOcuppance->setText(QApplication::translate("MainWindow", "Compute Ocuppance", 0, QApplication::UnicodeUTF8));
